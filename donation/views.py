...
def register_urdu_fonts():
    ...
    if not _URDU_FONT_REGISTERED:
        ...
        registered = False
        # Use NotoNastaliqUrdu.ttf as primary since it supports presentation forms required for connected letters in ReportLab
...
def export_monthly_pdf(request, year=None, month=None):
    ...
    if not leases.exists():
        ...
        for l in leases:
            ...
            col3_l = "وصول" if is_urdu else "Recd"
            lease_card_rows.append([
            ...
            if not l.payments.exists():
                no_lp_str = "کوئی ادائیگی نہیں" if is_urdu else "No payments"
            ...
            lbl_ta = "طے" if is_urdu else "Agr"
            lbl_tr_l = "وصول" if is_urdu else "Rec"
    ...
    lease_table = Table(lease_card_rows, colWidths=[40, 85, 65])
    lease_table_style = [
        ('SPAN', (0, 0), (-1, 0)),
